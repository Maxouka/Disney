...
export function SpaceMountain({ demoData, color }: SpaceMountainProps) {
  return (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="rounded-full bg-card-border px-2 py-0.5 text-[10px] font-mono text-muted">
                  {step.duration}
                </span>
              </div>
